    ...
    <body>
        ...
        <div class="text-center">
            <table class="text-center">
                ...
                <tr><td style="padding:10px"><a class="btn btn-default" href="./subjectview.jsp">Subject View</a><br/></td>
                    <td style="padding:10px"><a class="btn btn-default" href="./courseview.jsp">Course View</a><br/></td>
