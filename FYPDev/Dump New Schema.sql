...
CREATE TABLE `subjectfile` (
  ...
  KEY `subFile_subID_idx` (`subjectID`),
  KEY `subFile_secNo_idx` (`sectionNo`),
  ...
  CONSTRAINT `subFile_secNo` FOREIGN KEY (`sectionNo`) REFERENCES `lectlist` (`sectionNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `subFile_subID` FOREIGN KEY (`subjectID`) REFERENCES `subject` (`subjectID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-08-04 11:31:26
