...
CREATE TABLE `file_changelog` (
  ...
  PRIMARY KEY (`entryID`),
  KEY `subjectID` (`subjectID`),
  CONSTRAINT `file_changelog_ibfk_1` FOREIGN KEY (`subjectID`) REFERENCES `subject_list` (`subjectID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-08-02 10:40:04
